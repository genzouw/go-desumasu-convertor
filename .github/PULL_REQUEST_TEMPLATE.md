...
- [ ] 事前に Issue で承認された例外を除き、追加した SaaS / AI / ツール / GitHub App / Action は公開 OSS リポジトリで完全無料であり、その根拠 URL を本文に記載した（外部サービスを追加していない場合はチェック可。承認済み例外の場合は承認 Issue の URL を本文に記載）
